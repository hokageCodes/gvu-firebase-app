...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    // Fetch total number of colleges, departments, and levels
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-lg font-semibold mb-2">Total Number of Students</h2>
          <p className="text-4xl font-bold">{totalStudents}</p>
        </div>
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-lg font-semibold mb-2">Total Number of Colleges</h2>
          <p className="text-4xl font-bold">{totalColleges}</p>
        </div>
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-lg font-semibold mb-2">Total Number of Departments</h2>
